...
# Update App.tsx
sed -i "s|import { Login, Register } from './components/pages/Auth'|import { Login, Register } from './components/pages/Auth'\nimport Coach from './components/pages/Coach'|" src/App.tsx
sed -i "s|<Route path=\"/coach\" element={<Soon title=\"AI Coach\" />} />|<Route path=\"/coach\" element={<Coach />} />|" src/App.tsx

echo "✅ AI Coach page done!"
npm run dev
