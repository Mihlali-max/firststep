...
echo "🏛️ Building LAP Programmes page..."

cat > src/components/pages/LAP.tsx << 'EOF'
...
# Update App.tsx to use LAP page
sed -i "s|import { Login, Register } from './components/pages/Auth'|import { Login, Register } from './components/pages/Auth'\nimport LAP from './components/pages/LAP'|" src/App.tsx
sed -i "s|<Route path=\"/lap\" element={<Soon title=\"LAP Programmes\" />} />|<Route path=\"/lap\" element={<LAP />} />|" src/App.tsx

echo "✅ LAP Programmes page done!"
npm run dev
