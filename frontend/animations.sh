...
echo "💫 Adding animation engine..."

# Install framer-motion if not there
npm install framer-motion 2>/dev/null || true

# Create animation hook
cat > src/hooks/useAnimations.ts << 'EOF'
...
echo "✅ Animation hooks written. Now updating Home.tsx..."
